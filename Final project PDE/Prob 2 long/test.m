...
%--------------------------------------
  ...
  %...set up omega1
  q1    = zeros(N1,M1); q1(50:63,4:16)=1;q1  = q1(:);
   q2    = zeros(N2,M2);q2(2:15,36:48)=1;q2  = q2(:);
  q1S =  zeros(N1,1);
  q1N =  ones(N1,1);
  q1W =  zeros(1,M1);
  q1E =  zeros(1,M1);
...
%   q2    = zeros(N2,M2); q2  = q2(:);
  ...
  TimeEnd = 5; %Given in original DriverMain.m
  plotStep = 1;
  Schwarz_maxiter = 4; 
   ...
   %...diffusion
    ...
    q2old = q2;
      ...
      while 1
        ...
        GreenInterf = norm(interfWd-interfWdold);
        BlueInterf  = norm([(interfSd-interfSdold);(interfEd-interfEdold)']);
